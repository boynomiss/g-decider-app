            ...
            {[
              ...
              <TouchableOpacity
                ...
                onPress={() => onFiltersChange({ 
                  category: filters.category === category.id ? undefined : category.id as 'food' | 'activity' | 'something-new' 
                })}
              >
          ...
          <View style={styles.optionsGrid}>
            {[
              ...
              <TouchableOpacity
                ...
                onPress={() => onFiltersChange({ 
                  socialContext: filters.socialContext === social.id ? undefined : social.id as 'solo' | 'with-bae' | 'barkada' 
                })}
              >
          ...
          <View style={styles.optionsGrid}>
            {[
              ...
              <TouchableOpacity
                ...
                onPress={() => onFiltersChange({ 
                  budget: filters.budget === budget.id ? undefined : budget.id as 'P' | 'PP' | 'PPP' 
                })}
              >
                <Text style={[
                  styles.optionText,
          ...
          <View style={styles.optionsGrid}>
            {[
              ...
              <TouchableOpacity
                ...
                onPress={() => onFiltersChange({ 
                  timeOfDay: filters.timeOfDay === time.id ? undefined : time.id as 'morning' | 'afternoon' | 'night' 
                })}
              >
