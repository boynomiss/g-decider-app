...
import { UnifiedFilters } from '../src/features/filtering/types';
import { useDynamicFilterLogger, useSearchPreview, useFilterChangeTracker } from '../src/features/filtering';
...
export function DynamicFilterLoggerDemo() {
  ...
  const categoryOptions: { label: string; value: 'food' | 'activity' | 'something-new' | null }[] = [
  ...
  const socialOptions: { label: string; value: 'solo' | 'with-bae' | 'barkada' | null }[] = [
    { label: 'None', value: null },
  ...
  const budgetOptions: { label: string; value: 'P' | 'PP' | 'PPP' | null }[] = [
    { label: 'None', value: null },
  ...
  const timeOptions: { label: string; value: 'morning' | 'afternoon' | 'night' | null }[] = [
    { label: 'None', value: null },
