...
function convertFiltersToQueryParams(filters: UserFilters): QueryParams {
  ...
  if (filters.mood !== null) params.mood = filters.mood;
  if (filters.category !== null) params.category = filters.category;
  if (filters.budget !== null) params.budget = filters.budget;
  if (filters.timeOfDay !== null) params.timeOfDay = filters.timeOfDay;
  if (filters.socialContext !== null) params.socialContext = filters.socialContext;
  if (filters.distanceRange !== null) params.distanceRange = filters.distanceRange;
