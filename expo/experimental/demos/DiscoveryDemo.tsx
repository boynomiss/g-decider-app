...
import MoodSlider from '../src/features/filtering/components/MoodSlider';
import CategoryButtons from '../src/components/ui/CategoryButtons';

// Mock advertised places for demo - commented out as unused
...
export default function DiscoveryDemo() {
  ...
  return (
    <ScrollView style={styles.container}>
      ...
      {/* Discovery Interface - commented out as PlaceDiscoveryInterface is not imported */}
